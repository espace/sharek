...
from core.social_auth.backends.exceptions import AuthCanceled
...
class TwitterAuth(ConsumerBasedOAuth):
    ...
    SETTINGS_KEY_NAME = settings.TWITTER_CONSUMER_KEY
    SETTINGS_SECRET_NAME = settings.TWITTER_CONSUMER_SECRET
