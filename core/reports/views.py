...
def render_to_pdf(template_html, template_prefix, context, pdf_filename):
     ...
     command_args = 'wkhtmltopdf -L 10 -R 10 -T 20 -B 20 --footer-html ' + core.__path__[0] + '/static/footer.html?section=الجمعية التأسيسية لكتابة الدستور ' + full_temp_html_file_name + ' -'
