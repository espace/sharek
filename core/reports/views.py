...
def render_to_pdf(template_html, template_prefix, context, pdf_filename):
     ...
     command_args = 'wkhtmltopdf --footer-html ' + core.__path__[0] + '/static/footer.html --margin-top 15 --header-spacing 30 --margin-bottom 15 --footer-spacing 30 ' + full_temp_html_file_name + ' -'
